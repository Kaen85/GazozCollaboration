...
export default function ProjectFiles() {
  ...
  const getFileType = (filename) => {
    ...
    // Metin tabanlı dosyalar (TXT, Kod dosyaları vb.) - Tarayıcıda açılabilir
            ...
            {files.map(file => {
              ...
              return (
                ...
                >
                  ...
                  {/* GÖRÜNTÜLE / İNDİR (Sadece indirme butonu, silme kaldırıldı) */}
